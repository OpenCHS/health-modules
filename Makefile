...
setup-db:
	...
	curl -X POST http://192.168.73.1:8080/forms -d @deployables/mother/metadata/motherDeliveryForm.json -H "Content-Type: application/json"
	...
	curl -X POST http://192.168.73.1:8080/forms -d @deployables/mother/metadata/motherPNCForm.json -H "Content-Type: application/json"
