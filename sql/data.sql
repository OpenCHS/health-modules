...
BEGIN
    ...
    SELECT create_form_element_for_concept('Pallor', '0321fdc2-055f-44ac-a24e-c66314f04127', 1, FALSE , Physical, '[]', '5e9de8a2-eae3-479a-ab11-8576bab8319e', 'Boolean') INTO foo;
    SELECT create_form_element_for_concept('Pedal Edema', '57db3bc2-4a09-4351-bf44-edfe46e00ac1', 2, FALSE , Physical, '[]', '8928a9eb-25f0-4e6a-9e54-1ac1bebf9bfa', 'Boolean') INTO foo;
