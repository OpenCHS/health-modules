...
BEGIN
    ...
    SELECT create_form_element_for_concept('Temperature', '294c23fb-aef2-499c-b91f-3294df5a28c0', 2::SMALLINT, FALSE , vitals, '[]', '82558a1f-4412-4093-87de-6128b4eb5268', 'Numeric') INTO foo;
    SELECT create_form_element_for_concept('Respiratory Rate', '1840d8b3-93a8-4a17-8ef9-40767e21a0a7', 3::SMALLINT, FALSE , vitals, '[]', '0cd1c5c5-f003-4965-9ff0-685b1e6ed353', 'Numeric') INTO foo;
    SELECT create_form_element_for_concept('Pulse', 'd24edbd7-1ee5-4065-9f77-18aacd9bb88d', 4::SMALLINT, FALSE , vitals, '[]', 'be09a6be-ddd5-4fcc-8082-f77c725ed338', 'Numeric') INTO foo;
    SELECT create_form_element_for_concept('Systolic', '785c1b57-f494-49c1-aa88-499c9e0af894', 5::SMALLINT, FALSE , vitals, '[]', '104f5b1a-b3a6-441a-bf89-24b072854c38', 'Numeric') INTO foo;
    SELECT create_form_element_for_concept('Diastolic', 'e02226d8-2dd2-4cd7-ae1a-321a40d913f4', 6::SMALLINT, FALSE , vitals, '[]', '490a73da-df6e-4d92-82c6-37abea99deb8', 'Numeric') INTO foo;
    ...
    SELECT create_form_element_for_concept('Pallor', '0321fdc2-055f-44ac-a24e-c66314f04127', 1::SMALLINT, FALSE , Physical, '[{"key": "TrueValue", "value": "Present"}, {"key": "FalseValue", "value": "Absent"}]', '5e9de8a2-eae3-479a-ab11-8576bab8319e', 'Boolean') INTO foo;
    SELECT create_form_element_for_concept('Pedal Edema', '57db3bc2-4a09-4351-bf44-edfe46e00ac1', 2::SMALLINT, FALSE , Physical, '[{"key": "TrueValue", "value": "Present"}, {"key": "FalseValue", "value": "Absent"}]', '8928a9eb-25f0-4e6a-9e54-1ac1bebf9bfa', 'Boolean') INTO foo;
    SELECT create_form_element_for_concept_with_answers('Skin Condition', 'bfae2b55-5b91-4a1b-a6df-58d3cacf00b0', 3::SMALLINT, FALSE , Physical, '[{"key": "Select", "value": "Multi"}]', 'dd013943-8f20-4260-84e9-98cb0088a0f1',
    ...
    SELECT create_form_element_for_concept_with_answers('Paracheck', 'd797bb0c-7f75-4748-9db2-bd0349c1ee65', 4::SMALLINT, FALSE , Physical, '[{"key": "Select", "value": "Single"}]', '1fa71494-3b1c-433e-b3eb-13c9935b949a',
    ...
    SELECT create_form_element_for_concept_with_answers('Complaint', '55bec1f0-a726-4a9d-93eb-eb6e06231d36', 1::SMALLINT, TRUE, Complaint, '[{"key": "Select", "value": "Multi"}]', '8ec0637f-6f62-47ad-a0e6-08b8e3cf6f9d',
